#Group 30CM Python - FBI_Dataset - Arkadiusz
import os.path
import requests
import shutil
import xlrd
import matplotlib as mpl
mpl.use('TkAgg') # Fixing exception with Python framework error.

def download_file(file_name, url): # This function downloads the xls.
    split = url.split("/")
